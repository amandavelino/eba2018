				...
				<div class="row">
					...
					<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
						...
						<div class="info-delegacao listagem no-mobile">
							...
							<?php 
								// O CONTEÚDO ABAIXO FOI USADO PARA ESTILIZAR OS RESULTADOS DO MAPA,
								// QUANDO FINALIZAR O PHP PODE REMOVER POIS O MESMO SERÁ CARREGADO POR AJAX
							 ?>

							<?php /*
								<header>
									<img src="./imgs/bandeiras/BA.png" title="BA" height="40"><h3>Bahia</h3>
								</header>
								...
								<ul class="delegacao-itens">
									...
									<li>
										<div class="delegacao">
											<p>
												<span class="delegacao-nome">ADM de Paulo Afonso</span>
												<span class="delegacao-cidade">Paulo Afonso</span>
											</p>
										</div><!-- /delegacao -->
										<div class="responsavel">
											<p>
												<span class="resp-nome">ADM de Paulo Afonso</span>
												<span class="resp-email"><a href="mailto:admdepauloafonso@hotmail.com" target="_blank">admdepauloafonso@hotmail.com</a></span>
												<span class="resp-fone">(75) 9984.98542<br>(75) 9918.18218</span>
											</p>
										</div><!-- /responsavel -->
									</li>
									...
									<li>
										<div class="delegacao">
											<p>
												<span class="delegacao-nome">Chama Paris</span>
												<span class="delegacao-cidade">Paripiranga</span>
											</p>
										</div><!-- /delegacao -->
										<div class="responsavel">
											<p>
												<span class="resp-nome">Alessandro Barbosa de Santana</span>
												<span class="resp-email"><a href="mailto:al.bar.santana@gmail.com" target="_blank">al.bar.santana@gmail.com</a></span>
												<span class="resp-fone">(79) 9982.53715</span>
												<span class="resp-fone">(79) 9982.53715</span>
											</p>
										</div><!-- /responsavel -->
									</li>	
									...
									<li>
										<div class="delegacao">
											<p>
												<span class="delegacao-nome">EBA ALF</span>
												<span class="delegacao-cidade">Feira de Santana</span>
											</p>
										</div><!-- /delegacao -->
										<div class="responsavel">
											<p>
												<span class="resp-nome">André Filipe</span>
												<span class="resp-email"><a href="mailto:alfprojetos@hotmail.com" target="_blank">alfprojetos@hotmail.com</a></span>
												<span class="resp-fone">(75) 9165.8990</span>
												<span class="resp-fone">(79) 9982.53715</span>
											</p>
										</div><!-- /responsavel -->
									</li>																					
							...
							*/ ?>
							...
							<?php //REMOVER O CÓDIGO ACIMA, POIS ESTÁ DUPLICANDO O QUE ESTÁ SENDO CARREGADO POR AJAX ?>
			...
			<div class="mobileonly">
				...
				<div class="row">
					...
					<div class="col-sm-12 col-xs-12">					
						...
						<?php // O CONTEÚDO ABAIXO FOI USADO PARA ESTILIZAR OS RESULTADOS DO MAPA,
							  // QUANDO FINALIZAR O PHP PODE REMOVER ?>
						...
						<?php //REMOVER O CÓDIGO ACIMA, POIS ESTÁ DUPLICANDO O ABAIXO... ?>
